...
public class UpdateController {
    ...
    public static void setStage(Stage stage) {
        UpdateController.stage = stage;
    }

    public static void setLocale(Locale locale) {
        UpdateController.locale = locale;
    }
    ...
    @FXML
    private TextField dragonIdTextField;
    ...
    void update(ActionEvent event) {
        try {
            String dragonIdCheck = dragonIdTextField.getText();
            ...
            int id = Integer.parseInt(dragonIdCheck);
            ...
            if (y_coordinate > 67) {
                ...
                CommandStatusController.showCommandStatus(Client.update(dragon), "Dragons");
            }
    ...
    private void initLocale() {
        ...
        dragonIdLabel.setText(setString("id.label"));
